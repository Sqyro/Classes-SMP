...
public class LightningParticle extends SingleQuadParticle {
    ...
    protected LightningParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, SpriteSet Sprites) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xd, double yd, double zd, RandomSource Random) {
            return new LightningParticle(level, x, y, z, xd, yd, zd, Sprites);
        }
    }
}
